...
from lifecycle.phase2_directive import run_phase2
from lifecycle.phase3_reasoning import run_phase3
from lifecycle.phase4_validation import run_phase4
from protocol.messages import Directive, RecommendationResult
