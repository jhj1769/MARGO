"""Public façade — ``margo.recommend(...)`` for the web demo & evaluation.
...
from margo.domains.fashion.vocabulary import build_attribute_table, build_fashion_vocabulary
...
from margo.llm import LLMClient, PromptRegistry, get_default_client
from margo.protocol.messages import RecommendationResult
...
class MargoEngine:
    ...
    def _build_retriever(self, cfg: MargoEngineConfig, items: pd.DataFrame):
        ...
        if not cfg.bm25_only and index_path.exists() and ids_path.exists():
            ...
            from margo.retrieval.bge_retriever import BGERetriever
